    ...
    <div className={`h-screen text-black p-4 transition-all duration-300 ${isCollapsed ? 'w-16' : 'w-64'}`}>
      ...
      <nav className="mt-4">
        <div className="mb-2">
          ...
          <button className="flex items-center gap-2 text-black hover:text-blue-400" onClick={()=>navigate('/marketplace')}>
            <FaPlus /> {!isCollapsed && "Create an Agent"}
          </button>
          <button className="flex items-center gap-2 text-black hover:text-blue-400 mt-2" onClick={()=>navigate('/agents')}>
        ...
        <div className="mb-2">
          ...
          <button className="flex items-center gap-2 text-black hover:text-blue-400">
            <FaPlus /> {!isCollapsed && "Create a Store"}
          </button>
          <button className="flex items-center gap-2 text-black hover:text-blue-400 mt-2">
