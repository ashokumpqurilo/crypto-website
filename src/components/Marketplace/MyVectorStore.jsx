    ...
    <div className="p-4 bg-gray-100  h-screen flex  justify-center">
      <div className="w-full bg-gray-200 rounded-lg shadow-lg p-4">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-lg font-semibold text-black">Vector Stores</h2>
          <button className="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded" onClick={()=>navigate("/createVectorStore")}>Create</button>
        </div>
