      ...
      <div className="p-4 bg-gray-100 min-h-screen flex justify-center">
        <div className="w-full max-w-5xl bg-white rounded-lg shadow-lg p-4">
          <div className="flex flex-col sm:flex-row justify-between items-center mb-4">
            <h2 className="text-lg sm:text-xl font-bold text-gray-800">Stores</h2>
            <button
              className="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg shadow mt-2 sm:mt-0"
            ...
            <table className="w-full text-left border-collapse rounded-lg overflow-hidden">
              <thead>
                <tr className="bg-gray-200">
                  ...
                  <th className="p-2 sm:p-3">Created</th>
              ...
              <tbody>
                {stores.map((store, index) => (
                  ...
                  >
                    <td className="p-2 sm:p-3 text-blue-600 font-medium cursor-pointer">
                      {store.name}
                    </td>
                    <td className="p-2 sm:p-3 text-gray-700">{store.created}</td>
          ...
          <div className="flex justify-center mt-4 gap-4">
            <button className="border bg-gray-200 hover:bg-gray-300 text-black px-3 py-1 rounded-lg">
              &lt;
            </button>
            <button className="border bg-gray-200 hover:bg-gray-300 text-black px-3 py-1 rounded-lg">
              &gt;
