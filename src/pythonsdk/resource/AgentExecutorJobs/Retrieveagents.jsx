...
const Retrieveagents = () => {
    return (
        <div className="bg-white text-black p-8 min-h-screen">
          <h1 className="text-5xl font-bold">Retrieve an agent executor job
          </h1>
...
swarmnode.AgentExecutorJob.retrieve(id="15d19ca3-26f1-4adb-9cea-3955b73d9b4e")`}
              />
            </div>
          </div>
          <p className="mb-7 ">
