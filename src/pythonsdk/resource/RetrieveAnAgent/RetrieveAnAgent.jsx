...
swarmnode.AgentBuilderJob.retrieve(id="15d19ca3-26f1-4adb-9cea-3955b73d9b4e")`}
              />
            </div>
          </div>
          <p className="mb-7 ">
          Returns a AgentBuilderJob object.
            </p>
...
export default RetrieveAnAgent