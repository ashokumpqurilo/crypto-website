...
const RetrieveAnAgentExecutorCronJob = () => {
  const schemaData = {
    title: "Retrieve an agent executor cron job",
    request: {
    ...
    method: "GET",
    endpoint: "https://api.swarmnode.ai/v1/agent-executor-cron-jobs/:id/",
    description: "Returns an agent executor cron job for a valid ID.",
...
export default RetrieveAnAgentExecutorCronJob;
