...
const CreateAnAgentExecutorCronJob = () => {
  const schemaData = {
    title: "Create an agent executor cron job",
    request: {
    ...
    method: "POST",
    endpoint: "https://api.swarmnode.ai/v1/agent-executor-cron-jobs/create/",
    description: "Creates an agent executor cron job.",
  ...
  "created": "2024-12-28T11:16:10.045Z",
  "modified": "2024-12-28T11:16:10.045Z"
}`,
mainFields: [
...
export default CreateAnAgentExecutorCronJob;
