...
const RetrieveExecutorJob = () => {
  const schemaData = {
    title: "Retrieve an agent executor job",
    request: {
    ...
    method: "GET",
    endpoint: "https://api.swarmnode.ai/v1/agent-executor-jobs/:id/",
    description: "Returns an agent executor job for a valid ID.",
...
export default RetrieveExecutorJob;
